...
# correlation 
corr0 <- readRDS("tmp-data/corr_ldpred2_tutorial.rds")
...
```{r}
best_param <- data.frame(p = 0.0018, h2 = 0.1146, sparse = FALSE)
```
```{r}
...
```{r}
posterior_gv_samples <- big_prodMat(G, posterior_beta_samples, ind.col = ind.chr2)
