...
Pruning, as implemented in PLINK, sequentially scan the genomes for pairs of correlated SNPs, **keeping only the one with the higher MAF**. Let's use PLINK pruning on this simulated toy dataset.
