...
params[c("coef", "score")] <- 
  big_univLogReg(as_FBM(pred_grid[ind.val, ]), y[ind.val])[c("estim", "score")]
...
c(mad(pred_inf), mad(pred_auto))
```

```{r}
AUCBoot(pred_auto, y[ind.test])
```
