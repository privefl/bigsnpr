...
In [this preprint](https://doi.org/10.1101/2022.10.10.511629), we recently proposed an extension of this set, to provide an even better coverage of the genome by adding 37% more variants, and called it HapMap3+. This is the preferred set of variants to use with LDpred2 now.
...
- for [HapMap3+ variants with independent LD blocks](https://doi.org/10.6084/m9.figshare.21305061) (now recommended in [this preprint](https://doi.org/10.1101/2022.10.10.511629))
...
- along with an [example R script](https://github.com/privefl/paper-ldpred2/blob/master/code/example-with-provided-ldref.R) on how to use them
...
Here, you need `packageVersion("bigsnpr") >= package_version("1.11.4")`. Here is [the accompanying preprint](https://doi.org/10.1101/2022.10.10.511629).

```{r, echo=FALSE, out.width="80%", fig.cap="Overview of what LDpred2-auto can now provide"}
knitr::include_graphics("https://pbs.twimg.com/media/Fe7ZaIEWYAIklM7?format=png")
```
...
- Privé, F., Albiñana, C., Pasaniuc, B., & Vilhjálmsson, B. J. (2022). [Inferring disease architecture and predictive ability with LDpred2-auto](https://doi.org/10.1101/2022.10.10.511629). *bioRxiv*.
