...
```{r}
# Compute partial SVD using random projections
...
```{r}
# Association of each variable of `G` with `y` (adjusting for some `covar`)
...
### Polygenic Risk Score (PRS) with Penalized Logistic Regression
