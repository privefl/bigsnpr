...
// ldpred2_gibbs_auto
List ldpred2_gibbs_auto(const arma::sp_mat& corr, const NumericVector& betas_hat, const NumericVector& betas_init, const NumericVector& order, const NumericVector& n_vec, const NumericVector& h2_init, const NumericVector& p_init, int burn_in, int num_iter, double h2_min, double h2_max, double prob_jump_to_0, int ncores);
RcppExport SEXP _bigsnpr_ldpred2_gibbs_auto(SEXP corrSEXP, SEXP betas_hatSEXP, SEXP betas_initSEXP, SEXP orderSEXP, SEXP n_vecSEXP, SEXP h2_initSEXP, SEXP p_initSEXP, SEXP burn_inSEXP, SEXP num_iterSEXP, SEXP h2_minSEXP, SEXP h2_maxSEXP, SEXP prob_jump_to_0SEXP, SEXP ncoresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::sp_mat& >::type corr(corrSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type betas_hat(betas_hatSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type betas_init(betas_initSEXP);
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type h2_init(h2_initSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type ncores(ncoresSEXP);
    rcpp_result_gen = Rcpp::wrap(ldpred2_gibbs_auto(corr, betas_hat, betas_init, order, n_vec, h2_init, p_init, burn_in, num_iter, h2_min, h2_max, prob_jump_to_0, ncores));
    return rcpp_result_gen;
END_RCPP
}
// ldpred2_gibbs
arma::mat ldpred2_gibbs(const arma::sp_mat& corr, const NumericVector& betas_hat, const NumericVector& betas_init, const NumericVector& order, const NumericVector& n_vec, const NumericVector& h2, const NumericVector& p, const LogicalVector& sparse, int burn_in, int num_iter, int ncores);
RcppExport SEXP _bigsnpr_ldpred2_gibbs(SEXP corrSEXP, SEXP betas_hatSEXP, SEXP betas_initSEXP, SEXP orderSEXP, SEXP n_vecSEXP, SEXP h2SEXP, SEXP pSEXP, SEXP sparseSEXP, SEXP burn_inSEXP, SEXP num_iterSEXP, SEXP ncoresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::sp_mat& >::type corr(corrSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type num_iter(num_iterSEXP);
    Rcpp::traits::input_parameter< int >::type ncores(ncoresSEXP);
    rcpp_result_gen = Rcpp::wrap(ldpred2_gibbs(corr, betas_hat, betas_init, order, n_vec, h2, p, sparse, burn_in, num_iter, ncores));
    return rcpp_result_gen;
END_RCPP
}
// multLinReg
