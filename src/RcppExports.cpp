...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(wcrossprod(pBigMat, covar, y, z0, w0, tol, maxiter));
    return __result;
END_RCPP
}
// prs2
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(prs2(pBigMat, odds, indTest, indCol));
    return __result;
END_RCPP
}
// prs1
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const IntegerVector& >::type indTest(indTestSEXP);
    Rcpp::traits::input_parameter< const IntegerVector& >::type indCol(indColSEXP);
    __result = Rcpp::wrap(prs1(pBigMat, betas, indTest, indCol));
    return __result;
END_RCPP
}
// mycount
