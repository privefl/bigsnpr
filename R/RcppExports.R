...
ldpred2_gibbs <- function(corr, betas_hat, n_vec, h2, p, burn_in, num_iter, sparse, ncores) {
    .Call(`_bigsnpr_ldpred2_gibbs`, corr, betas_hat, n_vec, h2, p, burn_in, num_iter, sparse, ncores)
}
